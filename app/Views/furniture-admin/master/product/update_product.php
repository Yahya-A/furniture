                                ...
                                <input type="hidden" name="id_prod" value="<?= $product['id_prod']?>">
                                    <div class="row">
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="product_name" id="PName"
                                                placeholder="Tables - xxx " value="<?= $product['name']?>">
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-md-3">
                                            ...
                                            <input type="text" class="form-control" id="supplier" name="supplier"
                                                placeholder="LuxuryAssets" value="<?= $product['supplier']?>">
                                        </div>
                                        <div class="mb-3 col-md-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="alamat" class="form-control" id="spesification" rows="3"
                                            placeholder="More Spesification"><?= $product['spesification']?></textarea>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="text-center">
