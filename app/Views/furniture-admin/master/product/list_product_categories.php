                    ...
                    <table class="table table-hover my-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <img src="/assets/img/product/<?= $p['picture']?>" alt="" srcset="" width="150">
                                </td>
                                ...
                                <td>
                                    <div class="btn-group-vertical btn-group-sm" role="group">
                                        ...
                                        <a class="btn btn-secondary btn-sm" href="/product/delete_product?id=<?= base64_encode($p['id_prod'])?>"><i data-feather="trash-2"></i></a>
                                        <a class="btn btn-secondary btn-sm" href="/order/new_order_item"><i data-feather="shopping-bag"></i></a>
                                    </div>
                                </td>
                            </tr>
                            <?php 
